...
<div class="center_con_div" id="center_con_div">
	<div class="page_location_div">巡检计划-详情</div>
	...
	<div id="detail_div">
		...
		<table>
		  <tr>
			...
			<td class="td2">
				${requestScope.pp.name }
			</td>
			<td class="td1" align="right">
				计划类型
			</td>
			<td class="td2">
				<c:if test="${requestScope.pp.type eq 1 }">日常</c:if>
				<c:if test="${requestScope.pp.type eq 2 }">临时</c:if>
			</td>
		  </tr>
		  <tr>
			<td class="td1" align="right">
		  ...
		  <tr>
			...
			<td class="td2">
				间隔${requestScope.pp.frequency }分钟
			</td>
			<td class="td1" align="right">
				最少巡更人数
			</td>
			<td class="td2">
				${requestScope.pp.leastPopulation }
			</td>
		  </tr>
		</table>
		</form>
