...
public interface PatrolDeviceAccountService {
	...
	int queryForInt(String no, String pdName, Integer deptId, String deptName, String createTimeStart,
			String createTimeEnd, String startTimeStart, String startTimeEnd);

	List<PatrolDeviceAccount> queryList(String no, String pdName, Integer deptId,String deptName,
