...
public interface PatrolDeviceParamMapper {
	...
	int queryForInt(@Param("deptName") String deptName, @Param("pdName") String pdName, @Param("pdaNo") String pdaNo, @Param("name") String name, @Param("createTimeStart") String createTimeStart, @Param("createTimeEnd") String createTimeEnd);

	List<PatrolDeviceParam> queryList(@Param("deptName") String deptName, @Param("pdName") String pdName, @Param("pdaNo") String pdaNo, @Param("name") String name, 
